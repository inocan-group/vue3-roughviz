...
var vue = require('vue');
var roughViz = require('rough-viz');
...
var script = vue.defineComponent({
    ...
    setup(props) {
        const chartdiv = useSetupRoughVizChart(roughViz.Bar, props);
        return { chartdiv };
    },
});
...
var script$1 = vue.defineComponent({
    ...
    setup(props) {
        const chartdiv = useSetupRoughVizChart(roughViz.Donut, props);
        return { chartdiv };
    },
});
...
var script$2 = vue.defineComponent({
    props: Object.assign({}, barChartOptions),
    setup(props) {
        const chartdiv = useSetupRoughVizChart(roughViz.BarH, props);
        return { chartdiv };
    },
});
...
var script$3 = vue.defineComponent({
    ...
    setup(props, context) {
        ...
        const chartdiv = useSetupRoughVizChart(roughViz.Line, opts.value);
        return { chartdiv };
    },
});
...
var script$4 = vue.defineComponent({
    props: Object.assign({}, pieChartOptions),
    setup(props) {
        const chartdiv = useSetupRoughVizChart(roughViz.Pie, props);
        return { chartdiv };
    },
});
...
var script$5 = vue.defineComponent({
    ...
    setup(props) {
        const chartdiv = useSetupRoughVizChart(roughViz.Scatter, props);
        return { chartdiv };
    },
});
...
var script$6 = vue.defineComponent({
    ...
    setup(props) {
        const chartdiv = useSetupRoughVizChart(roughViz.StackedBar, props);
        return { chartdiv };
    },
});
